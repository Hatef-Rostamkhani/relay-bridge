"""
Pretty, column-aligned, color-aware logging for RelayBridge.
...
def print_banner(version: str, *, stream=None) -> None:
    ...
    art = [
        " ____  _____ _        ___  __   __  ____  ____  ___ ____   ____ _____ ",
        "| __ )| ____| |      / \\ \\/ /  | __ )|  _ \\|_ _|  _ \\ / ___| ____|",
        "|  _ \\|  _| | |     / _ \\  /   |  _ \\| |_) || || | | | |  _|  _|  ",
        "| |_) | |___| |___ / ___ \\/    | |_) |  _ < | || |_| | |_| | |___ ",
        "|____/|_____|_____/_/   \\_\\    |____/|_| \\_\\___|____/ \\____|_____|",
    ]
